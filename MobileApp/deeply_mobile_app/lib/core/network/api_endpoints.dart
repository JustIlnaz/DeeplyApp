class ApiEndpoints {
  ...
  static const String checkinStatus = '/api/features/checkin/weekly/status';

  static const String challengeTemplates = '/api/features/challenges/templates';
  static const String challengeActive = '/api/features/challenges/active';
  static String startChallenge(int id) => '/api/features/challenges/$id/start';
  static String markChallengeDay(int id, String day) =>
      '/api/features/challenges/$id/days/$day/done';
  static String completeChallenge(int id) =>
      '/api/features/challenges/$id/complete';
  ...
  static const String secretMessagesAll = '/api/features/secret-messages/all';
